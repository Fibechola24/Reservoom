...
public class DatabaseReservationValidator : IReservationConflictValidator
{
    private readonly ReservoomDbContextFactory _dbContextFactory;

    public DatabaseReservationValidator(ReservoomDbContextFactory dbContextFactory)
    {
    ...
    public async Task<Reservation> GetConflictingReservation(Reservation reservation)
    {
        using (ReservoomDbContext context = _dbContextFactory.CreateDbContext())
        {
            ReservationDTO reservationDTO = await context.Reservations
                ...
                .Where(r => r.StartTime < reservation.EndTime).FirstOrDefaultAsync();
